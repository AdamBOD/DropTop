import { Component, ComponentFactoryResolver, ViewContainerRef, Injector, ApplicationRef, EmbeddedViewRef, ComponentRef } from '@angular/core';
...
export class AppComponent {
  ...
  ngOnInit () {
    ...
    this.eventService.createEditModal.subscribe ((data) => {
      let componentFactory = this.componentFactoryResolver.resolveComponentFactory(EditModalComponent);
      ...
      this.editModalComponentRef = componentRef;
    });
